...
class ActionsAfipws
{
	...
	public function doActions($parameters, &$object, &$action, $hookmanager)
	{
        ...
        if (get_class($object)=="Facture"){
            //WSFE Permisos
            if ($object->statut > 0 && ($object->model_pdf == 'fe' || $object->model_pdf == 'afipws_fe' )) {   //agregar ExtraField en fatura llamado fe
...
*/
    public function formObjectOptions($parameters, $object, &$action)
    {
        ...
        if (get_class($object)=="Facture"){
            ...
            if ($action=='edit' || $action=='create'){
                ...
                print '<script type="text/javascript" language="javascript">
                        ...
                        //var cuit = $("#idprof1").val();
                        $("#idprof1").after("<a  href=\'#\' class=\'hideonsmartphone\'  onclick=\'javascript: AddbyCUIT();\'>' . $langs->trans('AddByCUIT') . '</a>");
                        });
                       </script>';
            }
        ...
        return 0; // Replace Dolibarr output
    }
