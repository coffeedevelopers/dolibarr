...
class wsfev1 {
	...
	*/
	public function __construct()
	{
        ...
        $this->path = $conf->afipws->dir_output.'/'.$conf->entity.'/';
		if ($conf->global->AFIPWS_WSAA_MODE == 0) { //MODE 1=produccion 0=Homologacion
            ...
            $this->url = $conf->global->AFIPWS_WSFE_SERVER;
        };
...
*/
	...
	*/	
	...
	// Primetec Agrego Opcionales para NCEA y NDEA (Rechazada y Comprobantes asociados y elimino Fecha de Vto)
	...
	// Primetec Agrego Opcionales para NC y ND (Rechazada y Comprobantes asociados y elimino Fecha de Vto)
