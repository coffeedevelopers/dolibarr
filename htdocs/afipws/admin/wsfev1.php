...
if ($action == 'update' && empty($_POST["cancel"]))
{
    ...
    $dirforkey=$conf->afipws->dir_output.'/'.$conf->entity.'/wsfev1/';
...
//    print '<form method="post" action="'.$_SERVER["PHP_SELF"].'">';
    ...
    if (file_exists($conf->afipws->dir_output.'/'.$conf->entity.'/wsfev1/'.$wsfepdf)) {
        print $wsfepdf;
    ...
    if (file_exists($conf->afipws->dir_output.'/'.$conf->entity.'/wsfev1/'.$wsfecsv)) {
        print $wsfecsv;
