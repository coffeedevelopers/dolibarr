        ...
        switch ($action) {
            case "BILL_VALIDATE":
                if ($object->thirdparty->country_code == "AR" || $object->thirdparty->country_code == '') {
                    if ($object->modelpdf == "afipws_fe" && $object->mode_reglement_code != "ECO") {
                        include_once "../../../../afipws/lib/wsfev1.lib.php";
                        return wsfev1($object);
                    }
                } else {
                    include_once "../../../../afipws/lib/wsfexv1.lib.php";
