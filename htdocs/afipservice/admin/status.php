...
require_once DOL_DOCUMENT_ROOT . '/afipservice/lib/afipservice.lib.php';
...
if ($action == 'delete'){
    ...
    $path=$conf->afipservice->dir_output.'/';
...
dol_fiche_head($head, 'serverstatus', $langs->trans("Module1050003Name"), -1, 'afipservice@afipservice');
...
$upload_dir = $conf->afipservice->dir_output.'/'.$conf->entity.'/xml/';
$filearray=dol_dir_list($upload_dir,"files",0,'','(\.meta|_preview.*\.png)$',$sortfield,(strtolower($sortorder)=='desc'?SORT_DESC:SORT_ASC),1);

$formfile=new FormFile($db);

print '<br>';
$formfile->list_of_documents($filearray,'','afipservice','',0,$conf->entity.'/xml/',1,0,'',0,'','',0);
