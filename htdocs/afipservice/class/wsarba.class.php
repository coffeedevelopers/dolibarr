...
class wsarba {
    ...
    */
    ...
    function ConsultarContribuyentes($fechaDesde, $fechaHasta, $cuitContribuyente)
    {
        ...
        $objxml->asXML(DOL_DOCUMENT_ROOT . "/afipservice/xml/" . $filename);
        ...
        // files to upload
        $files=array();
        $files['content'] = file_get_contents(DOL_DOCUMENT_ROOT . "/afipservice/xml/" . $filename);
        $files['type']= $this->getFileMimeType(DOL_DOCUMENT_ROOT . "/afipservice/xml/" . $filename);
...
// curl
        ...
        curl_setopt_array($curl, array(
            ...
            CURLOPT_TIMEOUT => 30,
                CURLOPT_CAINFO => DOL_DOCUMENT_ROOT . "/afipservice/keys/arba.crt",
