 ...
 */
class modreport extends DolibarrModules
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->numero = 500350;		// TODO Go on page http://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
		// Key text used to identify module (for permissions, menus, etc...)
		$this->rights_class = 'report';
		...
		$this->description = "reportico en Dolibarr";
		...
		$this->dirs = array("/report");

		// Config pages. Put here list of php page, stored into mymodule/admin directory, to use to setup module.
		$this->config_page_url = array("../report/admin/about.php");
		...
		$this->langfiles = array("report@report");
        ...
        // Dictionaries
	    if (! isset($conf->report->enabled))
        {
        	$conf->report=new stdClass();
        	$conf->report->enabled=0;
        }
        ...
        */
		...
		$r++;
		$this->rights[$r][0] = 500451;
		$this->rights[$r][1] = 'viewreports';
		$this->rights[$r][2] = 'r';
		$this->rights[$r][3] = 0;
		...
		$r++;
		$this->rights[$r][0] = 500455;
		$this->rights[$r][1] = 'editreports';
		$this->rights[$r][2] = 'r';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'report';
		...
		$r++;
		$this->rights[$r][0] = 500452;
		$this->rights[$r][1] = 'clientsreports';
		//$this->rights[$r][2] = 'r';
		$this->rights[$r][3] = 0;
		...
		$r++;
		$this->rights[$r][0] = 500453;
		$this->rights[$r][1] = 'suppliersreports';
		//$this->rights[$r][2] = 'r';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'suppliers';
		$this->rights[$r][5] = 'read';

		$r++;
		$this->rights[$r][0] = 500454;
		$this->rights[$r][1] = 'financialsreports';
		//$this->rights[$r][2] = 'r';
		$this->rights[$r][3] = 0;
		$this->rights[$r][4] = 'financials';
		$this->rights[$r][5] = 'read';

		$r++;
		$this->rights[$r][0] = 500456;
		$this->rights[$r][1] = 'productsreports';
		//$this->rights[$r][2] = 'r';
		$this->rights[$r][3] = 0;
		...
		$this->rights[$r][5] = 'read';
				...
				$r++;
		$this->rights[$r][0] = 500457;
		$this->rights[$r][1] = 'ticketsreports';
		//$this->rights[$r][2] = 'r';
		$this->rights[$r][3] = 0;
  ...
  $this->menu[$r]=array(	'fk_menu'=>0,		    // '' if this is a top menu. For left menu, use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
									...
									'position'=>100,
									'enabled'=>'$conf->report->enabled',  // Define condition to show or hide menu entry. Use '$conf->mymodule->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
									'perms'=>'1',			                // Use 'perms'=>'$user->rights->mymodule->level1->level2' if you want your menu with a permission rules
									'target'=>'',
									'user'=>0);				                // 0=Menu for internal users, 1=external users, 2=both
		 $r++;
	 $this->menu[$r]=array(  'fk_menu'=>'fk_mainmenu=report',
		                     'titre'=>'clientsreports',
		                     'leftmenu'=>'1',
		                      'url'=>'/report/clientsreports.php',
							  'enabled'=>'$conf->report->enabled',
		                      'langs'=>'report@report',
		                      'perms'=>'1',
		                      'target'=>'',
		                      'user'=>0 );
		...
		$r++;
		$this->menu[$r]=array(  'fk_menu'=>'fk_mainmenu=report',
			'titre'=>'suppliersreports',
			'leftmenu'=>'1',
			'url'=>'/report/suppliersreports.php',
			'enabled'=>'$conf->report->enabled',
			'langs'=>'report@report',
			'perms'=>'1',
			'target'=>'',
		...
		$r++;
		$this->menu[$r]=array(  'fk_menu'=>'fk_mainmenu=report',
			'titre'=>'productsreports',
			'leftmenu'=>'1',
			'url'=>'/report/productsreports.php',
			'enabled'=>'$conf->report->enabled',
			'langs'=>'report@report',
			'perms'=>'1',
			'target'=>'',
		...
		$r++;
		$this->menu[$r]=array(  'fk_menu'=>'fk_mainmenu=report',
			'titre'=>'financialsreports',
			'leftmenu'=>'1',
			'url'=>'/report/financialsreports.php',
			'enabled'=>'$conf->report->enabled',
			'langs'=>'report@report',
			'perms'=>'1',
			'target'=>'',
		...
		$this->menu[$r]=array(  'fk_menu'=>'fk_mainmenu=report',
			...
			$r++;
		$this->menu[$r]=array(  'fk_menu'=>'fk_mainmenu=report',
			'titre'=>'operationsreports',
			'leftmenu'=>'1',
			'url'=>'/report/operationsreports.php',
			'enabled'=>'$conf->report->enabled',
			'langs'=>'report@report',
			'perms'=>'1',
			'target'=>'',
			...
			$r++;
		$this->menu[$r]=array(  'fk_menu'=>'fk_mainmenu=report',
			'titre'=>'administrationsreports',
			'leftmenu'=>'1',
			'url'=>'/report/administrationsreports.php',
			'enabled'=>'$conf->report->enabled',
			'langs'=>'report@report',
			'perms'=>'1',
			'target'=>'',
		...
		$r++;
		$this->menu[$r]=array(  'fk_menu'=>'fk_mainmenu=report',
			'titre'=>'ordenesreports',
			'leftmenu'=>'1',
			'url'=>'/report/ordenesreports.php',
			'enabled'=>'$conf->report->enabled',
			'langs'=>'report@report',
			'perms'=>'1',
			'target'=>'',
		...
		$r++;
		$this->menu[$r]=array(  'fk_menu'=>'fk_mainmenu=report',
			'titre'=>'ticketsreports',
			'leftmenu'=>'1',
			'url'=>'/report/ticketsreports.php',
			'enabled'=>'$conf->report->enabled',
			'langs'=>'report@report',
			'perms'=>'1',
			'target'=>'',
