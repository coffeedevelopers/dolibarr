...
/**
 * \file    test/functional/OperacionesFunctionalTest.php
 * \ingroup operaciones
...
/**
 * Class OperacionesFunctionalTest
 *
 ...
 */
class OperacionesFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modOperaciones')->click();
		} else {
			// Disable the module
			$this->byHref('modOperaciones')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/operaciones/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('operaciones/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/operaciones/admin/about.php');
		$this->authenticate();
		return $this->assertContains('operaciones/admin/about.php', $this->url(), 'About page');
	}
...
return $this->assertEquals(
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('operacioneswidget1', $this->source(), "Box enabled");
	}
...
return $this->assertContains(
			'interface_99_modOperaciones_OperacionesTriggers.class.php',
...
return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modOperaciones_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
