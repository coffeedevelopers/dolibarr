...
/**
 *	\file       operaciones/operacionesindex.php
 *	\ingroup    operaciones
 *	\brief      Home page of operaciones top menu
 */
...
$langs->loadLangs(array("operaciones@operaciones"));

$action=GETPOST('action', 'alpha');


// Securite acces client
if (! $user->rights->operaciones->read) accessforbidden();
...
llxHeader("", $langs->trans("OperacionesArea"));

print load_fiche_titre($langs->trans("OperacionesArea"), '', 'operaciones.png@operaciones');
...
// Draft MyObject
if (! empty($conf->operaciones->enabled) && $user->rights->operaciones->read)
{
	$langs->load("orders");
