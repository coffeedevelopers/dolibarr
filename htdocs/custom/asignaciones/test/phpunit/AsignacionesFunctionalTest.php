...
/**
 * \file    test/functional/AsignacionesFunctionalTest.php
...
/**
 * Class AsignacionesFunctionalTest
 *
 ...
 *
 * @package Testasignaciones
 */
class AsignacionesFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modAsignaciones')->click();
		} else {
			// Disable the module
			$this->byHref('modAsignaciones')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/asignaciones/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('asignaciones/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/asignaciones/admin/about.php');
		$this->authenticate();
		return $this->assertContains('asignaciones/admin/about.php', $this->url(), 'About page');
	}
...
return $this->assertEquals(
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('asignacioneswidget1', $this->source(), "Box enabled");
	}
...
return $this->assertContains(
			'interface_99_modAsignaciones_AsignacionesTriggers.class.php',
...
return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modAsignaciones_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
