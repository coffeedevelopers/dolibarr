...
/**
 *	\file       asignaciones/asignacionesindex.php
 *	\ingroup    asignaciones
 *	\brief      Home page of asignaciones top menu
 */
...
$langs->loadLangs(array("asignaciones@asignaciones"));

$action=GETPOST('action', 'alpha');


// Securite acces client
if (! $user->rights->asignaciones->read) accessforbidden();
...
llxHeader("", $langs->trans("AsignacionesArea"));

print load_fiche_titre($langs->trans("Asignaciones"), '', 'user-plus-solid.svg@asignaciones');
...
// Draft MyObject
if (! empty($conf->asignaciones->enabled) && $user->rights->asignaciones->read)
{
	$langs->load("orders");
